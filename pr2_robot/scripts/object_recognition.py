...
# Project used: https://github.com/camisatx/RoboticsND/tree/master/projects/perception
...
def pcl_callback(pcl_msg):
    ...
    passthrough_1.set_filter_field_name('y')
    y_axis_min = -0.4
    y_axis_max = 0.4
    passthrough_1.set_filter_limits(y_axis_min, y_axis_max)
    ...
    passthrough_2.set_filter_field_name('z')
    z_axis_min = 0.61
    z_axis_max = 0.9
    passthrough_2.set_filter_limits(z_axis_min, z_axis_max)
